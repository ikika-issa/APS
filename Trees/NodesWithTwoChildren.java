...
for which you will need to answer Q questions of the type "how many nodes with exactly two children are there in the subtree of a selected node"..
...
public class NodesWithTwoChildren{
    public static int countNodesWithTwoChildren(BNode<?> node) {
