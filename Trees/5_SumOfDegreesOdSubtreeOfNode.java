...
public class SumOfDegreesOdSubtreeOfNode{
    public static int degreeOfNode(BNode<String> node) {
        int degree = 0;
    ...
    public static int sumOfDegrees(BNode<String> node) {
        ...
        return degreeOfNode(node) + sumOfDegrees(node.left) + sumOfDegrees(node.right);
    }
    ...
    public static void main(String[] args){
        ...
        for (int i = 0; i <= N + M; i++) {
            ...
            if(line.split(" ")[0].equals("root")){
                ...
                System.out.println(sumOfDegrees(node));
            }
        }
    }
}
