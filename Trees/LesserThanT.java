/*You are given a binary search tree with N integers. Write a function that, for a binary search tree and a selected element T from the tree will you will find how many elements in the tree are smaller than T
/You will need to use that function Q times when building the tree.
The input will contain N+Q rows of the type. Insert value - You need to insert the value value into the tree. Ask value- You need to answer how many elements in the tree have a value less than value
*/
...
public class Main{
    ...
    private static int countGreaterThan(BNode<Integer> t, int x) {
        ...
        if (t.info > x) {
            return countGreaterThan(t.left, x);
        } else {
        ...
        for(int i = 0; i < n + m; i++){
            ...
            if(line.equals("insert")){
               tree.insert(number);
                ...
                System.out.println(countGreaterThann(tree, number) - 1);
            }
        }
