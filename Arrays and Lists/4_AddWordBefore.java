...
//You need to insert a new node with value "Outlier" before each node that contains a String with more than L characters in the list.
...
public class Main{
    public static void DeleteSpecial(SLL<String> list, int k){
        ...
        while(word != null){
            if(word.element.length() > k){
                list.insertBefore("Outlier", word);
            }
            word = word.succ;
        }
