//Calculate the sum of the nodes which only have left children.
...
public class SumLeft {
    public static int sumLeft(BNode<Integer> node){
        if(node == null){
            return 0;
        }
    ...
    public static void main(String[] args){
        ...
        tree.makeRoot(1);
        BNode<Integer> a = tree.addChild(tree.root, 1, 7);
        BNode<Integer> b = tree.addChild(a, 1, 2);
        BNode<Integer> c = tree.addChild(tree.root, 2, 9);
        BNode<Integer> d = tree.addChild(c, 2, 19);
        BNode<Integer> e = tree.addChild(d, 1, 15);


        System.out.print("The sum is " + sumLeft(tree.root));
