//Нека се дадени две еднострано поврзани листи чии jазли се сортирани во растечки редослед. Да се напише функциjа коjа ´ке ги спои двете листи во една така што резултантната листа да е сортирана. 
...
public class SLL_MergeSortedLists{
    public static void main(String[] args){
        ...
        SLLNode<Integer> second = list1.getFirst();
