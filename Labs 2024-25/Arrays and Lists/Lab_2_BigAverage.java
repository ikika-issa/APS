...
public class BiggerThanAverage{
    ...
    public static void BigAverage(DLL<Integer> list) {
        ...
        while(num != null) {
            //zbirot od site elementi - zbirot od elementite levo - vrednosta na konkretniot node
            int rightSum = totalSum - leftSum - num.element;
            int rightCount = totalCount - leftCount - 1;

            float avgLeft = (float)leftSum / leftCount;
            float avgRight = (float)rightSum / rightCount;
