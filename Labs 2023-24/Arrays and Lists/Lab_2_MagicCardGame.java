...
public class MysticalCardGame {
    ...
    public static void startDuel(SLL<Card> firstSorcererCards, SLL<Card> secondSorcererCards) {
        SLLNode<Card> firstSorcerer = firstSorcererCards.getFirst(); //card from the first sorcerer
        SLLNode<Card> secondSorcerer = secondSorcererCards.getFirst(); //card from the second sorcerer
        ...
        SLLNode<Card> chosenOne = null;

        int worth = firstSorcerer.element.getHealth() * firstSorcerer.element.getMagicPower();

        while(firstSorcerer != null){
            int worthh = firstSorcerer.element.getHealth() * firstSorcerer.element.getMagicPower();
            if(worth < worthh){
                worth = worthh;
